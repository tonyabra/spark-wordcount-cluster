...
echo "1 file test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-00000-ip-10-180-212-252.ec2.internal.warc.wet /data
...
echo "3 file test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-00001-ip-10-180-212-252.ec2.internal.warc.wet /data
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-00002-ip-10-180-212-252.ec2.internal.warc.wet /data
...
echo "10 files test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-0000*-ip-10-180-212-252.ec2.internal.warc.wet /data
...
echo "30 files test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-000[1-2]*-ip-10-180-212-252.ec2.internal.warc.wet /data
...
echo "90 files test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-000[3-8]*-ip-10-180-212-252.ec2.internal.warc.wet /data
...
echo "300 files test."
hdfs dfs -mv /back-data/CC-MAIN-20150124161055-00*-ip-10-180-212-252.ec2.internal.warc.wet /data
